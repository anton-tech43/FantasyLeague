...
struct MockData {
    ...
    static let example1: ContentItem = {
        let json = """
        {
            ...
            "talking_points": [
                "Do you think Viktor Gyökeres was worth £85 millions?",
            ...
            "immersive_headline": "new in, viktor gyökeres, striker.",
            "immersive_context_fallback": "Like Hailey Bieber leaving Rhode to go all in with Dior. Massive."
        }
        """.data(using: .utf8)!
    ...
    static let example2: ContentItem = {
        ...
        let json = """
        {
            ...
            "talking_points": {
                "regular": [
                    "Do you think Saka's stepping up today against Tottenham?",
            ...
            "immersive_headline": "derby, arsenal vs tottenham.",
            "immersive_context_fallback": "This is like two siblings fighting. Bring this shit up and let that boy taaaaalk"
        }
        """.data(using: .utf8)!
        return try! mockDecoder.decode(ContentItem.self, from: json)
    }()
    ...
    static let example3: ContentItem = {
        let json = """
        {
            ...
            "talking_points": [
                "Do you actually think de Jong's happening this time?",
            ...
            "immersive_context_fallback": "This is like your friend saying they're 'definitely moving abroad this year' for the fourth year running"
        }
        """.data(using: .utf8)!
        return try! mockDecoder.decode(ContentItem.self, from: json)
    }()
    ...
    static let example4: ContentItem = {
        let json = """
        {
            ...
            "talking_points": [
                "How long is Bowen actually out for though?",
            ...
            "immersive_headline": "bowen injured, he'll be gutted.",
            "immersive_context_fallback": "Like your fave makeup artist cancelling right before an event. Absolute disaster timing"
        }
        """.data(using: .utf8)!
        return try! mockDecoder.decode(ContentItem.self, from: json)
    }()
    ...
    static let example5: ContentItem = {
        let json = """
        {
            ...
            "talking_points": [
                "Who do you think the manager was talking about?",
            ...
            "immersive_headline": "the manager went off, drama.",
            "immersive_context_fallback": "Like your boss sending an all-staff email about 'standards.' Everyone is panicking"
        }
        """.data(using: .utf8)!
        return try! mockDecoder.decode(ContentItem.self, from: json)
    }()
