...
| **P0** | A15 | **Larmet kraschar.** CHECK 2 `FORMAT('%.0f')` → Postgres stöder bara `%s %I %L`. **Fix skriven: mig 081** (bygger på prod-definitionen, inte 041) — ROUND()::text + `%s`, plus nytt CHECK 6 (A17). Körs av Anton. | app (mig 081) |
