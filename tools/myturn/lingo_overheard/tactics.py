...
OVERHEARD = {
    ...
    "playmaker": dict(
        ...
        decoy="The one taking the corners and free kicks",
    ...
    "winger": dict(
        ...
        spare="A defender who gets forward out wide",
        when=["any"],
        moment="common",
        player=dict(
            slot='theirs.forward',
    ...
    "tiki-taka": dict(
        ...
        decoy="Chanting from the away end on repeat",
    ...
    "long-ball": dict(
        ...
        decoy="Shooting from forty yards or further",
    ...
    "xg": dict(
        ...
        decoy="The shots on target added up",
        spare="How many goals a side scores in a season",
    ...
    "game-management": dict(
        ...
        decoy="Changing the shape after an hour",
        spare="The manager barking at them from the side",
    ...
    "dark-arts": dict(
        ...
        decoy="A weakened side put out on purpose",
