...
OVERHEARD = {
    "formation": dict(
        ...
        decoy="The eleven he picks to start the match",
        spare="The way they set up for corners and free kicks",
    ...
    "back-four": dict(
        ...
        decoy="The players sitting furthest back on the bench",
        spare="The four across the middle of the pitch",
    ...
    "centre-back": dict(
        ...
        spare="The one who whips the crosses in from wide",
    ...
    "full-back": dict(
        ...
        decoy="An attacker who hugs the touchline all game",
        spare="A defender who plays the whole ninety every week",
        when=["any"],
        moment="common",
    ),
    "wing-back": dict(
        ...
        decoy="A back-up who covers out wide when needed",
        spare="A midfielder who stays out on the touchline",
        when=["any", "new-manager"],
        moment="common",
    ),
    "holding-midfielder": dict(
        ...
        decoy="A player told to hold on to the ball",
        spare="The one who plays just behind the striker",
        when=["any"],
        moment="common",
        player=dict(
    ...
    "box-to-box": dict(
        ...
        decoy="The one who pings it from one box to the other",
        spare="A midfielder who gets forward to score goals",
        when=["any"],
        moment="anytime",
    ),
    "number-ten": dict(
        ...
        decoy="The player wearing the shirt with ten on",
        spare="The one the manager picks as captain",
        when=["any"],
        moment="common",
    ),
    "playmaker": dict(
        ...
        decoy="The one who takes the corners and free kicks",
        spare="The one who barks the orders at everyone",
        when=["any"],
        moment="anytime",
        player=dict(
    ...
    "winger": dict(
        ...
        decoy="The forward who plays just off the striker",
        spare="A defender who gets forward down the touchline",
        when=["any"],
        moment="common",
        player=dict(
            slot='theirs.forward',
    ...
    "striker": dict(
        ...
        decoy="The one who strikes the dead balls for them",
        spare="The player who plays behind the front man",
        when=["any", "window"],
        moment="anytime",
    ),
    "target-man": dict(
    ...
    "false-nine": dict(
        ...
        decoy="A player faking an injury to waste some time",
        spare="A forward told to stay high on the shoulder",
        when=["any"],
        moment="rare",
    ),
    "pressing": dict(
    ...
    "counter-attack": dict(
        ...
        decoy="Scoring straight back after going behind",
    ...
    "tiki-taka": dict(
        ...
        decoy="The chant the away end sings on repeat",
        spare="A quick one-two played round a defender",
        when=["any", "europe"],
        moment="common",
    ),
    "long-ball": dict(
        ...
        decoy="A shot struck from forty yards or further",
        spare="The cross whipped in low from the byline",
    ...
    "man-marking": dict(
        ...
        decoy="Each defender covering an area of the pitch",
        spare="Standing goal-side of your man at a corner",
    ...
    "zonal-marking": dict(
        ...
        spare="The wall lined up in front of a free kick",
    ...
    "set-piece": dict(
        ...
        decoy="The eleven a manager settles on for a game",
        spare="A goal that comes straight from open play",
    ...
    "overlap": dict(
        ...
        decoy="A pass rolled inside instead of out wide",
        spare="A player drifting into a teammate's space",
        when=["any", "opp-close-range"],
        moment="common",
    ),
    "through-ball": dict(
        ...
        decoy="A ball nudged past a player's legs",
    ...
    "cutback": dict(
        ...
        decoy="A player turning inside to lose a marker",
        spare="A cross floated to the far post",
        when=["any", "opp-close-range"],
        moment="common",
    ),
    "inverted-full-back": dict(
        ...
        decoy="A defender playing on the opposite side",
        spare="A midfielder dropping in among the defence",
        when=["any"],
        moment="rare",
    ),
    "half-space": dict(
        ...
        decoy="The half of the pitch a side sets up to defend",
        spare="The strip of grass right in front of the goal mouth",
        when=["any"],
        moment="common",
    ),
    "xg": dict(
        ...
        decoy="How many goals a side should score in a season",
        spare="The shots on target added up",
    ...
    "game-management": dict(
        ...
        decoy="The manager barking at them from the side",
        spare="Changing the shape after an hour",
    ...
    "dark-arts": dict(
        ...
        decoy="Playing a weakened side on purpose",
        spare="Rough tackling meant to rattle them",
    ...
    "rotation": dict(
        ...
        decoy="Players taking turns as captain in a season",
        spare="Swapping positions with someone mid-match",
        when=["cup", "europe"],
        moment="rare",
        player=dict(
            slot='ours.keeper',
