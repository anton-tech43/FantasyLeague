...
OVERHEARD = {
    ...
    "group-chat": dict(
        ...
        decoy="Any online forum open to supporters",
    ...
    "kop": dict(
        ...
        decoy="Steep old terracing, where tickets are cheap",
    ...
    "the-boot-room": dict(
        ...
        decoy="Storing the kit in a room at the ground",
    ...
    "silly-season": dict(
        ...
        decoy="Christmas and New Year, games back to back",
