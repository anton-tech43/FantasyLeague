...
OVERHEARD = {
    "kick-off": dict(
        ...
        decoy="The coin toss that decides which way to play",
    ...
    "full-time": dict(
        ...
        decoy="The end of the first of the two halves",
    ...
    "nil-nil": dict(
        ...
        spare="A draw where both sides scored",
    ...
    "top-four": dict(
        ...
        decoy="Winning the league and lifting the trophy",
        spare="The sides who reach a cup semi-final",
    ...
    "in-the-book": dict(
        ...
        decoy="He has been sent off and must leave",
        spare="The referee has spoken to him and let him off",
        when=["any", "derby"],
        moment="common",
    ),
    "hooked": dict(
    ...
    "dead-rubber": dict(
        ...
        spare="A match replayed after a draw",
        when=["run-in", "europe"],
        moment="rare",
    ),
    "giant-killing": dict(
    ...
    "top-drawer": dict(
        ...
        decoy="The top division of English football",
    ...
    "second-ball": dict(
        ...
        decoy="A cross played in after a short corner",
