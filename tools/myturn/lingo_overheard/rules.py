...
OVERHEARD = {
    "premier-league": dict(
        ...
        decoy="The league for the top clubs in Britain",
    ...
    "points": dict(
        ...
        decoy="One for every goal scored",
    ...
    "the-table": dict(
        ...
        decoy="A fixture list for the weekend's games",
    ...
    "goal-difference": dict(
        ...
        decoy="The margin in a single match",
    ...
    "relegation": dict(
        ...
        decoy="A player pushed down to the reserves",
    ...
    "promotion": dict(
        ...
        decoy="A move up into the first team",
    ...
    "offside": dict(
        ...
        decoy="The ball had already gone out for a goal kick",
        spare="He got in the keeper's way at the near post",
        when=["any"],
        moment="common",
    ),
    "var": dict(
    ...
    "clear-and-obvious": dict(
        ...
        decoy="Footage good enough to see it",
        spare="A decision the referee got right first time",
        when=["any"],
        moment="rare",
    ),
    "foul": dict(
        ...
        decoy="A decision the referee got wrong",
    ...
    "handball": dict(
        ...
        decoy="The keeper picking the ball up outside his box",
        spare="Grabbing an opponent's shirt to hold him back",
        when=["any"],
        moment="common",
    ),
    "penalty": dict(
    ...
    "yellow-card": dict(
        ...
        decoy="A fine the club pays the league",
    ...
    "added-time": dict(
        ...
        decoy="A count of how long the ball was out of play",
        spare="Time carried over from the first half",
        when=["any"],
        moment="common",
    ),
    "extra-time": dict(
        ...
        decoy="A short break before penalties are taken",
    ...
    "penalty-shootout": dict(
        ...
        decoy="One kick each until somebody misses",
    ...
    "two-legs": dict(
        ...
        decoy="The two halves either side of the break",
    ...
    "aggregate": dict(
        ...
        decoy="A club's goals across a season",
    ...
    "the-bench": dict(
        ...
        decoy="The staff sat in the dugout",
    ...
    "clean-sheet": dict(
        ...
        decoy="A game with no cards and no trouble",
    ...
    "brace": dict(
        ...
        decoy="A strapping worn on a knee or ankle",
    ...
    "assist": dict(
        ...
        decoy="Any pass in the move that led to the goal",
    ...
    "fixtures": dict(
        ...
        decoy="Dates the tickets go on sale",
    ...
    "derby": dict(
        ...
        decoy="Any game with a real edge to it",
        spare="A fixture played every year on the same day",
        when=["derby"],
        moment="rare",
    ),
    "the-cups": dict(
    ...
    "fa-cup": dict(
        ...
        decoy="The competition every club in Europe can enter",
        spare="The cup for the top two divisions",
        when=["cup"],
        moment="rare",
    ),
    "league-cup": dict(
    ...
    "champions-league": dict(
        ...
        decoy="A competition for the winners of each division",
        spare="The summer tournament between national sides",
    ...
    "europa-league": dict(
        ...
        decoy="The knockout stage of Europe's top competition",
    ...
    "conference-league": dict(
        ...
        decoy="A division below the Football League",
    ...
    "deadline-day": dict(
        ...
        decoy="The final day to buy tickets for the season",
    ...
    "sacked": dict(
        ...
        decoy="A player dropped from the squad for a game",
